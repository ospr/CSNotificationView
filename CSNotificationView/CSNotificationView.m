...
+ (void)showInViewController:(UIViewController*)viewController
         behindNavigationBar:(BOOL)behindNavigationBar
                   tintColor:(UIColor*)tintColor
                        font:(UIFont*)font
                    ...
                    duration:(NSTimeInterval)duration
{
    ...
    __block CSNotificationView* note = [[CSNotificationView alloc] initWithParentViewController:viewController];
    note.behindNavigationBar = behindNavigationBar;
    note.tintColor = tintColor;
    note.image = image;
        ...
        if (!self.superview) {
            ...
            if (self.parentNavigationController) {
                if (self.isBehindNavigationBar) {
                    ...
                    [self.parentNavigationController.view insertSubview:self aboveSubview:self.parentNavigationController.navigationBar];
                }
            } else {
...
- (CGFloat)topLayoutGuideLengthCalculation
{
    ...
    if (self.isBehindNavigationBar && self.parentNavigationController && !self.parentNavigationController.navigationBarHidden) {
